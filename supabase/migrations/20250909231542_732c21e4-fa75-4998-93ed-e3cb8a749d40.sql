...
ALTER VIEW public.employees_public SET (security_barrier = true);

-- Create RLS policy for the public view - regular users can see basic info only
CREATE POLICY "Company members can view basic employee info"
